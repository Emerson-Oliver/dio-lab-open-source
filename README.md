...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/Emerson-Oliver`: `git checkout -b feat/community/seunomedeusuario`;
    > Exemplo: `git checkout -b feat/community/emersonoliveira`
